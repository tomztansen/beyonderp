...
import type { Params, Route } from './types.t.js';
...
export type GenerateUrlOptions<T, R extends object, C extends object> = ParseOptions & Readonly<{
    /**
...
declare function generateUrls<T = unknown, R extends object = EmptyObject, C extends object = EmptyObject>(resolver: Resolver<T, R, C>, options?: GenerateUrlOptions<T, R, C>): UrlGenerator;
