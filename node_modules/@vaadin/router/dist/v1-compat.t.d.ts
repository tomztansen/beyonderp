...
import type { Commands, RouteContext, Route, ActionResult, ChildrenCallback, WebComponentInterface } from './types.t.js';
/**
 ...
 */
export type ActionFn = (this: Route, context: RouteContext, commands: Commands) => MaybePromise<ActionResult | RouteContext>;
/**
...
//# sourceMappingURL=v1-compat.t.d.ts.map