...
public class FormBuilderView extends VerticalLayout {
    ...
    private final Button toggleViewBtn = new com.vaadinerp.components.SafeButton(VaadinIcon.TABLE.create());
    ...
    public FormBuilderView(FormMetaRepository formMetaRepository, LovMetaRepository lovMetaRepository,
        ...
        Button btnAutoGenerateFields = new com.vaadinerp.components.SafeButton("⚡ Auto-Generate Fields dari Tabel/View",
        ...
        Button btnConfigScheduler = new com.vaadinerp.components.SafeButton("Config Scheduler",
                com.vaadin.flow.component.icon.VaadinIcon.CALENDAR_CLOCK.create(), e -> {
                    if (formCodeField.getValue() == null || formCodeField.getValue().trim().isEmpty()) {
                        Notification.show("Fill in the Form Code (unique) first!", 3000,
        ...
        Button togglePaletteBtn = new com.vaadinerp.components.SafeButton(VaadinIcon.MENU.create());
        ...
        Button togglePropsBtn = new com.vaadinerp.components.SafeButton(VaadinIcon.COG_O.create());
        ...
        Button fullscreenBtn = new com.vaadinerp.components.SafeButton(VaadinIcon.EXPAND_FULL.create());
        ...
        Button btnBulkDelete = new com.vaadinerp.components.SafeButton("🗑️ Delete Selected");
        ...
        Button btnBulkGroupRow = new com.vaadinerp.components.SafeButton("🔀 Group into same Row");
    ...
    private Button createPaletteButton(String label, VaadinIcon icon, String type) {
        Button btn = new com.vaadinerp.components.SafeButton(label, icon.create());
        btn.setWidthFull();
    ...
    private Component buildFieldCard(FieldMetaTemp temp, int sequence) {
        ...
        centerTarget.addDropListener(e -> {
            ...
            if (!draggedFields.isEmpty() && (!draggedFields.contains(temp))) {
                ...
                Button btnCancel = new com.vaadinerp.components.SafeButton("Cancel", ev -> canvasPanel.remove(overlay));
                Button btnSwap = new com.vaadinerp.components.SafeButton("Swap", ev -> {
    ...
    private void openDynamicValidationDialog(FieldMetaTemp field) {
        ...
        Button btnSave = new com.vaadinerp.components.SafeButton("Terapkan Validasi", VaadinIcon.CHECK.create(), e -> {
    ...
    private void openOnAddScriptDialog(FieldMetaTemp fieldTemp) {
        ...
        Button btnGenerateAi = new com.vaadinerp.components.SafeButton("✨ Buatkan Aturan (AI)",
        ...
        Button btnSimulate = new com.vaadinerp.components.SafeButton("▶ Simulasikan Script pada 3 Baris Dummy",
    ...
    private void openFilterConfigDialog(FieldMetaTemp fieldTemp) {
        ...
        filtersGrid.addComponentColumn(fTemp -> {
            Button btnEdit = new com.vaadinerp.components.SafeButton(VaadinIcon.PENCIL.create());
            btnEdit.addThemeVariants(ButtonVariant.LUMO_SMALL, ButtonVariant.LUMO_TERTIARY);
        ...
        Button btnClose = new com.vaadinerp.components.SafeButton("Selesai", e -> dialog.close());
    ...
    private void openLovTargetsConfigDialog(FieldMetaTemp fieldTemp) {
        ...
        btnAdd.addClickListener(e -> {
            ...
            if (srcCol == null || trgField == null) {
                Notification.show("Source column and target field must be selected!", 3000, Notification.Position.MIDDLE);
                return;
            }
    ...
    private void buildToolbar() {
        ...
        // 1. TAMBAH BUTTON
        Button btnNew = new com.vaadinerp.components.SafeButton("Add");
        ...
        // 1.5. EDIT BUTTON
        Button btnEdit = new com.vaadinerp.components.SafeButton("Edit");
        ...
        // 2. HAPUS BUTTON
        Button btnDelete = new com.vaadinerp.components.SafeButton("Delete");
        ...
        btnDelete.addClickListener(e -> {
            if (tabSheet.getSelectedTab() == historisTab) {
                ...
                if (!formCode.isEmpty() && formMetaRepository.existsById(formCode)) {
                    showConfirmDialog("Confirm Delete", "Are you sure you want to delete this form definition?",
                            () -> {
                                try {
                                    formMetaRepository.deleteById(formCode);
                                    Notification.show("Form definition deleted successfully!", 3000,
                                            Notification.Position.TOP_CENTER);
                    ...
                    Notification.show("No saved form is currently open to delete.", 3000,
                            Notification.Position.MIDDLE);
                }
            }
        });
        ...
        // 2.5. COPY BUTTON
        Button btnCopy = new com.vaadinerp.components.SafeButton("Copy");
        ...
        btnCopy.addClickListener(e -> {
            ...
            if (selected != null) {
                ...
                Notification.show("Enter a new Form Code and press Save.", 4000,
                        Notification.Position.MIDDLE);
                formCodeField.focus();
            } else {
        ...
        // 3. SIMPAN BUTTON
        Button btnSave = new com.vaadinerp.components.SafeButton("Save");
        ...
        // 4. BATAL BUTTON
        Button btnCancel = new com.vaadinerp.components.SafeButton("Cancel");
        ...
        // 5. REFRESH BUTTON
        Button btnRefresh = new com.vaadinerp.components.SafeButton("Refresh");
        ...
        java.util.List<FormMeta> filtered = allHistoryItems.stream().filter(item -> {
            ...
            return true;
                ...
                .sorted(java.util.Comparator
                        .comparing(item -> item.getFormCode() == null ? "" : item.getFormCode().toLowerCase()))
                .collect(java.util.stream.Collectors.toList());
    ...
    private void openAutoGenerateDialog() {
        ...
        if (availableTables.isEmpty()) {
            Notification.show("Fill in Target Table Name, View Table or Detail Table Name first!",
        ...
        Span infoSpan = new Span("💡 Columns already on the canvas and default audit columns are not generated.");
        ...
        Button btnGenerate = new com.vaadinerp.components.SafeButton("Generate", VaadinIcon.DATABASE.create());
        ...
        Button btnCancelDialog = new com.vaadinerp.components.SafeButton("Cancel", e -> dialog.close());
    ...
    private void openRelayoutDialog() {
        ...
        Dialog dialog = new Dialog();
        dialog.setHeaderTitle("🔀 Rearrange Form Column Layout");
        ...
        Button btnApply = new com.vaadinerp.components.SafeButton("Terapkan Layout", VaadinIcon.CHECK.create());
    ...
    private void openSchedulerConfigDialog() {
        ...
        Button testBtn = new com.vaadinerp.components.SafeButton("🔍 Test Query & Load Columns",
        ...
        testBtn.addClickListener(e -> {
            ...
            if (sql == null || sql.trim().isEmpty()) {
                showError("Peringatan", "The query cannot be empty!");
                return;
            }
            try {
                ...
                dynamicDataService.getJdbcTemplate().query(testSql, rs -> {
                    ...
                    allCbs.forEach(cb -> cb.setItems(cols));
                    showSuccess("Sukses", "Query is valid. Found " + colCount + " columns.");
                    return null;
                });
            } catch (Exception ex) {
        ...
        Button btnSave = new com.vaadinerp.components.SafeButton("Save Configuration", VaadinIcon.CHECK.create(), e -> {
            try {
