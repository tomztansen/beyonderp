...
public class FormBuilderView extends VerticalLayout {
    ...
    private final Button propBtnEditLov = new com.vaadinerp.components.SafeButton("Edit LOV Config", VaadinIcon.EDIT.create());
    ...
    private final Button propBtnFilters = new com.vaadinerp.components.SafeButton("Configure Filters", VaadinIcon.FILTER.create());
    private final Button propBtnLovTargets = new com.vaadinerp.components.SafeButton("Configure LOV Targets", VaadinIcon.LINK.create());
    private final Button propBtnCustomValidation = new com.vaadinerp.components.SafeButton("🛡️ Atur Validasi Dinamis", VaadinIcon.SHIELD.create());
    private final Button propBtnOnAddScript = new com.vaadinerp.components.SafeButton("⚡ On-Add-Row Script & AI", VaadinIcon.CODE.create());
    ...
    public FormBuilderView(FormMetaRepository formMetaRepository, LovMetaRepository lovMetaRepository,
        ...
        Button btnRelayoutCanvas = new com.vaadinerp.components.SafeButton("🔀 Atur Ulang Layout Berjejer (3 Kolom, 4 Kolom, dst)",
    ...
    private void openOnAddScriptDialog(FieldMetaTemp fieldTemp) {
        ...
        Button btnGenerateAi = new com.vaadinerp.components.SafeButton("✨ Buatkan Aturan (AI)", VaadinIcon.LIGHTBULB.create());
        ...
        Button btnSimulate = new com.vaadinerp.components.SafeButton("▶ Simulasikan Script pada 3 Baris Dummy", VaadinIcon.PLAY.create());
    ...
    private void openSchedulerConfigDialog() {
        ...
        Button testBtn = new com.vaadinerp.components.SafeButton("🔍 Test Query & Load Columns", VaadinIcon.SEARCH.create());
        ...
        Button btnSave = new com.vaadinerp.components.SafeButton("Simpan Konfigurasi", VaadinIcon.CHECK.create(), e -> {
            try {
