...
public class GenericMasterDetailFormView extends VerticalLayout implements HasUrlParameter<String> {
    ...
    private void buildMasterGrid(FormMeta formDef) {
        ...
        for (FieldMeta field : sortedFields) {
            ...
            if (field.getHyperlinkTargetForm() != null && !field.getHyperlinkTargetForm().isBlank()) {
                col = masterGrid.addColumn(new com.vaadin.flow.data.renderer.ComponentRenderer<>(map -> {
                    ...
                    link.addClickListener(e -> {
                        ...
                        com.vaadin.flow.component.Component comp = GenericMasterDetailFormView.this;
                ...
                col = masterGrid.addColumn(valueGetter::apply);
            }
    ...
    private void buildDetailsGrid(FormMeta formDef) {
        ...
        for (FieldMeta field : detailFields) {
            ...
            Grid.Column<Map<String, Object>> col;
            if (field.getHyperlinkTargetForm() != null && !field.getHyperlinkTargetForm().isBlank()) {
                col = detailsGrid.addColumn(new com.vaadin.flow.data.renderer.ComponentRenderer<>(map -> {
                    String text = valueGetter.apply(map);
                    if (text == null || text.isBlank()) return new com.vaadin.flow.component.html.Span();
                ...
                col = detailsGrid.addColumn(valueGetter::apply);
            }
